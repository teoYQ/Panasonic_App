...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future uploadFile(String email, String password,) async {
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                            onPressed: () {
                              ...
                              database.reference().child("Users").update({_name : _email});
                              database.reference().update({_name : {"dose" : 0 , "lights" : "off", "temperature" : 25}});
